...
/*
The block of code below is used to enable monitoring to the users that that have logged into the system.
session is an instance of a package called express-session. The block of code below is implementing a package
*/
